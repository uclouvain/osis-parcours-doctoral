...
from learning_unit.models.learning_class_year import get_case_when_statement_pour_code_complet
...
def annotate_queryset_with_activity_learning_info(queryset, activity_field='', with_title=False):
    ...
    qs = queryset.annotate(
        learning_year_acronym=Coalesce(
            get_case_when_statement_pour_code_complet(
                lookup_to_learning_unit_acronym=f'{base_field}learning_class_year__learning_component_year__learning_unit_year__acronym',
    ...
    qs = qs.alias(
        learning_year_base_title_fr=Coalesce(
            f'{base_field}learning_class_year__learning_component_year__learning_unit_year__learning_container_year__common_title',
            f'{base_field}learning_unit_year__learning_container_year__common_title',
            models.Value(''),
        ),
        learning_year_base_title_en=Coalesce(
            f'{base_field}learning_class_year__learning_component_year__learning_unit_year__learning_container_year__common_title_english',
...
def filter_queryset_by_learning_year(queryset, acronyms: List[str], year: int, activity_field=''):
    ...
    for acronym in acronyms:
        ...
        conditions |= Q(
            **(
                {
                    f'{base_field}learning_class_year__learning_component_year__learning_unit_year__academic_year__year': year,
                    f'{base_field}learning_class_year__learning_component_year__learning_unit_year__acronym': lu_acronym,
