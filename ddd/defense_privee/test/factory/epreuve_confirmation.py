...
from parcours_doctoral.ddd.defense_privee.domain.model._demande_prolongation import (
    DemandeProlongation,
)
...
class _DefensePriveeFactory(factory.Factory):
    class Meta:
        model = DefensePrivee
        abstract = False
...
class DefensePrivee0DoctoratSC3DPFactory(_DefensePriveeFactory):
    entity_id = factory.SubFactory(_DefensePriveeIdentityFactory, uuid='c0')
...
class DefensePrivee1DoctoratSC3DPFactory(_DefensePriveeFactory):
    entity_id = factory.SubFactory(_DefensePriveeIdentityFactory, uuid='c1')
    parcours_doctoral_id = factory.SubFactory(
        _ParcoursDoctoralIdentityFactory, uuid='uuid-pre-SC3DP-promoteurs-membres-deja-approuves'
    )
...
class DefensePrivee2DoctoratSC3DPFactory(_DefensePriveeFactory):
    entity_id = factory.SubFactory(_DefensePriveeIdentityFactory, uuid='c2')
    parcours_doctoral_id = factory.SubFactory(
        _ParcoursDoctoralIdentityFactory, uuid='uuid-pre-SC3DP-promoteurs-membres-deja-approuves'
    )
...
class DefensePriveeDoctoratSC3DPRefusFactory(_DefensePriveeFactory):
    entity_id = factory.SubFactory(_DefensePriveeIdentityFactory, uuid='c10')
    parcours_doctoral_id = factory.SubFactory(
        _ParcoursDoctoralIdentityFactory,
