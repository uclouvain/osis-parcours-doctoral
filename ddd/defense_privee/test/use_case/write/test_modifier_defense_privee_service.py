...
class TestModifierDefensePrivee(SimpleTestCase):
    @classmethod
    def setUpClass(cls):
        super().setUpClass()
        cls.cmd = ModifierDefensePriveeCommand
    ...
    def setUp(self):
        ...
        self.parametres_cmd = {
            ...
            'titre_these': 'Titre 2',
            'date_heure': datetime.datetime(2023, 1, 1),
            'lieu': 'Lieu 2',
            'date_envoi_manuscrit': datetime.date(2024, 1, 1),
            'proces_verbal': ['file-2'],
        }

    def test_should_soumettre_defense_privee(self):
