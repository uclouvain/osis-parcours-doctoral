...
from parcours_doctoral.ddd.defense_privee.commands import (
    CompleterDefensePriveeParPromoteurCommand,
)
...
class TestCompleterDefensePriveeParPromoteur(TestCase):
    def setUp(self):
    ...
    def test_should_completer_defense_privee_si_valide(self):
        ...
        self.assertEqual(defense_privee_mise_a_jour.proces_verbal_ca, ['mon_fichier_4'])
        self.assertEqual(defense_privee_mise_a_jour.avis_renouvellement_mandat_recherche, ['mon_fichier_5'])
