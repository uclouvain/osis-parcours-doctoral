...
class TestInviterJuryRecevabilite(SimpleTestCase):
    @classmethod
    def setUpClass(cls):
        super().setUpClass()
        cls.cmd = InviterJuryRecevabiliteCommand
    ...
    def setUp(self):
        ...
        self.recevabilite = RecevabiliteFactory(
        ...
        self.parametres_cmd = {
            'parcours_doctoral_uuid': self.recevabilite.parcours_doctoral_id.uuid,
        }
    ...
    def test_should_generer_exception_si_statut_parcours_doctoral_invalide(self):
        proposition = self.parcours_doctoral_repository.get(entity_id=self.recevabilite.parcours_doctoral_id)
    ...
    def test_should_inviter_jury(self):
        proposition = self.parcours_doctoral_repository.get(entity_id=self.recevabilite.parcours_doctoral_id)
        proposition.statut = ChoixStatutParcoursDoctoral.RECEVABILITE_SOUMISE
