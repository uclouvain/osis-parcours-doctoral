...
class TestSoumettreReportDate(TestCase):
    ...
    def test_should_soumettre_report_date_si_valide(self):
        ...
        defense_privee_mise_a_jour = next(
            epreuve
        ...
        self.assertIsNotNone(defense_privee_mise_a_jour.demande_prolongation)
        self.assertEqual(
            defense_privee_mise_a_jour.demande_prolongation.nouvelle_echeance,
            datetime.date(2022, 4, 1),
        )
        self.assertEqual(
            defense_privee_mise_a_jour.demande_prolongation.justification_succincte,
            'Ma raison',
        )
