...
def recuperer_derniere_defense_privee(
    cmd: 'RecupererDerniereDefensePriveeQuery',
    ...
    # THEN
    return defense_privee_repository.get_active_dto_by_parcours_doctoral_identity(parcours_doctoral_id)
