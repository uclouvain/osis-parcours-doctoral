...
def soumettre_defense_privee(
    ...
    defense_privee = defense_privee_repository.get(defense_privee_id, cmd.parcours_doctoral_uuid)
    ...
    parcours_doctoral.soumettre_defense_privee()

    # THEN
    notification.notifier_soumission(defense_privee=defense_privee)
    parcours_doctoral_repository.save(parcours_doctoral)
    defense_privee_repository.save(defense_privee)
    historique.historiser_soumission_defense_privee(parcours_doctoral, cmd.matricule_auteur)
