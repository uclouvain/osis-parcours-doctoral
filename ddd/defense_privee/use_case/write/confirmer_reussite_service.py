...
def confirmer_reussite(
    ...
    parcours_doctoral.encoder_decision_reussite_defense_privee()

    # THEN
    notification.notifier_reussite_epreuve(defense_privee)
    parcours_doctoral_repository.save(parcours_doctoral)
    historique.historiser_reussite_defense_privee(parcours_doctoral, cmd.matricule_auteur)
