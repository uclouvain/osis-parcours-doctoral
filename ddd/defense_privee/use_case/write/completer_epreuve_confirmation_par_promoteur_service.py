...
def completer_defense_privee_par_promoteur(
    cmd: 'CompleterDefensePriveeParPromoteurCommand',
    ...
    # WHEN
    defense_privee.completer_par_promoteur(
        proces_verbal_ca=cmd.proces_verbal_ca,
        avis_renouvellement_mandat_recherche=cmd.avis_renouvellement_mandat_recherche,
    )

    # THEN
    notification.notifier_completion_par_promoteur(defense_privee=defense_privee)
