...
class ParcoursDoctoralSC3DPAvecPromoteurRefuseEtMembreCADejaApprouveFactoryRejeteeCDDFactory(_ParcoursDoctoralFactory):
    entity_id = factory.SubFactory(
        _ParcoursDoctoralIdentityFactory, uuid='uuid-SC3DP-promoteur-refus-membre-deja-approuve'
    )
    formation_id = FormationIdentity(sigle='SC3DP', annee=2022)
...
class ParcoursDoctoralSC3DPAvecPromoteursEtMembresCADejaApprouvesFactory(_ParcoursDoctoralFactory):
    entity_id = factory.SubFactory(
        _ParcoursDoctoralIdentityFactory, uuid='uuid-SC3DP-promoteurs-membres-deja-approuves'
    )
    formation_id = FormationIdentity(sigle='SC3DP', annee=2022)
...
class ParcoursDoctoralSC3DPAvecPromoteurRefuseEtMembreCADejaApprouveFactory(ParcoursDoctoralSC3DPMinimaleFactory):
    entity_id = factory.SubFactory(
        _ParcoursDoctoralIdentityFactory, uuid='uuid-SC3DP-promoteur-refus-membre-deja-approuve-2'
    )
    matricule_doctorant = 'candidat'
