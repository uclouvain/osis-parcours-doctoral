...
from parcours_doctoral.ddd.jury.commands import RenvoyerInvitationSignatureCommand
...
class TestRenvoyerInvitationSignature(SimpleTestCase):
    def setUp(self) -> None:
    ...
    def test_renvoyer_invitation_signature(self):
