...
class TestReinitialiserSignatures(SimpleTestCase):
    def setUp(self) -> None:
    ...
    def test_reinitialiser_signatures(self):
        ...
        for membre in jury.membres:
            self.assertEqual(membre.signature.etat, ChoixEtatSignature.NOT_INVITED)
