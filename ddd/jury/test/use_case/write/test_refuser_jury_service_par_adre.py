...
class TestRefuserJuryParAdre(SimpleTestCase):
    def setUp(self) -> None:
    ...
    def test_refuser_jury(self):
        ...
        membre = next(m for m in jury.membres if m.role == RoleJury.ADRE)
        self.assertEqual(membre.signature.etat, ChoixEtatSignature.DECLINED)
        ...
        self.assertEqual(membre.signature.motif_refus, 'Refus')
