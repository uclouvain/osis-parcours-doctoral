...
from parcours_doctoral.ddd.jury.commands import VerifierJuryConditionSignatureQuery
...
def verifier_jury_condition_signature(
    cmd: 'VerifierJuryConditionSignatureQuery',
    jury_repository: 'IJuryRepository',
) -> 'JuryIdentity':
    # GIVEN
    entity_id = JuryIdentityBuilder.build_from_uuid(cmd.uuid_jury)
    jury = jury_repository.get(entity_id)
