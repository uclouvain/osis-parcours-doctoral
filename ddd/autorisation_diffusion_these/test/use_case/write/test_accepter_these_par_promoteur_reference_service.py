...
class TestAccepterTheseParPromoteurReference(SimpleTestCase):
    @classmethod
    def setUpClass(cls):
        super().setUpClass()
        cls.cmd = AccepterTheseParPromoteurReferenceCommand
    ...
    def test_doit_generer_exception_si_statut_incorrect(self):
        ...
        self.assertIsInstance(
            e.exception.exceptions.pop(), AutorisationDiffusionTheseNonModifiableParPromoteurReferenceException
        )
    ...
    def test_doit_modifier_statut_et_enregistrer_informations_acceptation(self):
        ...
        self.assertEqual(autorisation.statut, ChoixStatutAutorisationDiffusionThese.DIFFUSION_VALIDEE_PROMOTEUR)
        ...
        self.assertEqual(promoteur.signature.etat, ChoixEtatSignature.APPROVED)
        ...
        self.assertEqual(adre.signature.etat, ChoixEtatSignature.INVITED)
