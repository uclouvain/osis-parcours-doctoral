...
class TestRefuserTheseParAdre(SimpleTestCase):
    @classmethod
    def setUpClass(cls):
        super().setUpClass()
        cls.cmd = RefuserTheseParAdreCommand
    ...
    def test_doit_modifier_statut_et_enregistrer_informations_refus(self):
        ...
        self.assertEqual(autorisation.statut, ChoixStatutAutorisationDiffusionThese.DIFFUSION_REFUSEE_ADRE)
        ...
        self.assertEqual(adre.signature.etat, ChoixEtatSignature.DECLINED)
        self.assertEqual(adre.signature.commentaire_externe, self.parametres_cmd['commentaire_externe'])
        self.assertEqual(adre.signature.motif_refus, self.parametres_cmd['motif_refus'])
