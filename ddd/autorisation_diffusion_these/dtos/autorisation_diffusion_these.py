...
class AutorisationDiffusionTheseDTO(interface.DTO):
    uuid: str
    ...
    modalites_diffusion_acceptees_le: Optional[datetime.date]

    signataires: List[SignataireAutorisationDiffusionTheseDTO]
