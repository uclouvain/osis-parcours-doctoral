...
def envoyer_formulaire_autorisation_diffusion_these_au_promoteur_reference(
    ...
    entity.envoyer_formulaire_au_promoteur_reference(matricule_promoteur_reference=matricule_promoteur_reference)

    autorisation_diffusion_these_repository.save(entity)

    notification.inviter_promoteur_reference(autorisation_diffusion_these=entity)
