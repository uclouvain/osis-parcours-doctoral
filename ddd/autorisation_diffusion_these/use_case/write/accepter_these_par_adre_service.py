...
def accepter_these_par_adre(
    cmd: AccepterTheseParAdreCommand,
    ...
    matricule_gestionnaire_sceb = (
        signataires_initiaux_autorisation_diffusion_these_service.recuperer_fgs_gestionnaire_sceb()
    )

    entity.accepter_these_par_adre(
        matricule_adre=cmd.matricule_adre,
        commentaire_interne=cmd.commentaire_interne,
        commentaire_externe=cmd.commentaire_externe,
        matricule_sceb=matricule_gestionnaire_sceb,
    )

    autorisation_diffusion_these_repository.save(entity)

    notification.accepter_these_par_adre(autorisation_diffusion_these=entity)
