...
@attr.dataclass(frozen=True, slots=True)
class AccepterTheseParPromoteurValidatorList(TwoStepsMultipleBusinessExceptionListValidator):
    statut: ChoixStatutAutorisationDiffusionThese
    signataire: 'SignataireAutorisationDiffusionThese'
...
@attr.dataclass(frozen=True, slots=True)
class AccepterTheseParAdreValidatorList(TwoStepsMultipleBusinessExceptionListValidator):
    statut: ChoixStatutAutorisationDiffusionThese
    signataire: 'SignataireAutorisationDiffusionThese'
...
@attr.dataclass(frozen=True, slots=True)
class RefuserTheseParScebValidatorList(TwoStepsMultipleBusinessExceptionListValidator):
    statut: ChoixStatutAutorisationDiffusionThese
    motifs_refus: str
    signataire: 'SignataireAutorisationDiffusionThese'
