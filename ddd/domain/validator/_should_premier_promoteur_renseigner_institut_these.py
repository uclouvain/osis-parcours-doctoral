...
from parcours_doctoral.ddd.domain.model._signature_promoteur import (
    SignaturePromoteur,
)
from parcours_doctoral.ddd.domain.validator.exceptions import InstitutTheseObligatoireException
