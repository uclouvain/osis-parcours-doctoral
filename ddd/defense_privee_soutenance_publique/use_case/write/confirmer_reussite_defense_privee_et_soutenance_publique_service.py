...
def confirmer_reussite_defense_privee_et_soutenance_publique(
    cmd: 'ConfirmerReussiteDefensePriveeEtSoutenancePubliqueCommand',
    ...
    # WHEN
    parcours_doctoral.confirmer_reussite_defense_privee_et_soutenance_publique_formule_2(
    ...
    historique.historiser_decision_reussie_defense_privee_et_soutenance_publique(
        parcours_doctoral=parcours_doctoral,
