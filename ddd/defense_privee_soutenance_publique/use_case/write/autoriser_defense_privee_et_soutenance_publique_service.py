...
def autoriser_defense_privee_et_soutenance_publique(
    cmd: 'AutoriserDefensePriveeEtSoutenancePubliqueCommand',
    ...
    # WHEN
    parcours_doctoral.autoriser_defense_privee_et_soutenance_publique_formule_2()
    ...
    historique.historiser_autorisation_defense_privee_et_soutenance_publique(
        parcours_doctoral=parcours_doctoral,
