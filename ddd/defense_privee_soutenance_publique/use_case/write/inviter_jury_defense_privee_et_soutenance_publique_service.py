...
from parcours_doctoral.ddd.defense_privee_soutenance_publique.domain.service.i_notification import (
    INotification,
)
...
def inviter_jury_defense_privee_et_soutenance_publique(
    cmd: 'InviterJuryDefensePriveeEtSoutenancePubliqueCommand',
    parcours_doctoral_repository: 'IParcoursDoctoralRepository',
    notification: 'INotification',
    personne_connue_ucl_translator: 'IPersonneConnueUclTranslator',
) -> ParcoursDoctoralIdentity:
    # GIVEN
    parcours_doctoral_identity = ParcoursDoctoralIdentity(uuid=cmd.uuid_parcours_doctoral)
    ...
    # WHEN
    parcours_doctoral.inviter_jury_defense_privee_et_soutenance_publique_formule_2()
