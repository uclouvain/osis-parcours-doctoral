...
def modifier_defense_privee_et_soutenance_publique(
    cmd: 'ModifierDefensePriveeEtSoutenancePubliqueCommand',
    ...
    # WHEN
    parcours_doctoral.modifier_defense_privee_et_soutenance_publique_formule_2(
        ...
        lieu_soutenance_publique=cmd.lieu_soutenance_publique,
        local_deliberation=cmd.local_deliberation,
        informations_complementaires=cmd.informations_complementaires,
        ...
        date_retrait_diplome=cmd.date_retrait_diplome,
    )
    ...
    defense_privee.modifier(
        ...
        proces_verbal=cmd.proces_verbal_defense_privee,
    )
