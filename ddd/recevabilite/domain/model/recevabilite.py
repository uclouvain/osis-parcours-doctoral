...
class RecevabiliteIdentity(interface.EntityIdentity):
    uuid: str


@attr.dataclass(slots=True, hash=False, eq=False)
class Recevabilite(interface.RootEntity):
    entity_id: RecevabiliteIdentity
    ...
    avis_jury: List[str] = attr.Factory(list)
