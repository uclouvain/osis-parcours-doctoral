...
class TestConfirmerEchecRecevabilite(SimpleTestCase):
    @classmethod
    def setUpClass(cls):
        super().setUpClass()
        cls.cmd = ConfirmerEchecRecevabiliteCommand
    ...
    def test_should_changer_statut_parcours_doctoral(self):
        ...
        self.assertEqual(self.parcours_doctoral.statut, ChoixStatutParcoursDoctoral.RECEVABILITE_EN_ECHEC)
