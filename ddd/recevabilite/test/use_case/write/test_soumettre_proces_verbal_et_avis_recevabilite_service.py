...
class TestSoumettreProcesVerbalEtAvisRecevabilite(SimpleTestCase):
    @classmethod
    def setUpClass(cls):
        super().setUpClass()
        cls.cmd = SoumettreProcesVerbalEtAvisRecevabiliteCommand
    ...
    def test_should_soumettre_documents_recevabilite(self):
