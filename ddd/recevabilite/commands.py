...
class RecupererRecevabilitesQuery(interface.QueryRequest):
    parcours_doctoral_uuid: str


@attr.dataclass(frozen=True, slots=True)
class SoumettreRecevabiliteCommand(interface.CommandRequest):
    parcours_doctoral_uuid: str
...
@attr.dataclass(frozen=True, slots=True)
class ConfirmerRecevabiliteARecommencerCommand(interface.CommandRequest):
    parcours_doctoral_uuid: str
