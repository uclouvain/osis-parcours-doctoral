...
def confirmer_echec_recevabilite(
    cmd: 'ConfirmerEchecRecevabiliteCommand',
    ...
    # WHEN
    parcours_doctoral.confirmer_echec_recevabilite(recevabilite=recevabilite)
    ...
    historique.historiser_decision_echec_recevabilite(
        parcours_doctoral=parcours_doctoral,
