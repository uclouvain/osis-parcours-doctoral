...
def confirmer_recevabilite_a_recommencer(
    ...
    nouvelle_recevabilite = RecevabiliteBuilder.build_from_parcours_doctoral_id(parcours_doctoral_identity)

    # WHEN
    parcours_doctoral.confirmer_repetition_recevabilite(recevabilite=recevabilite)
    recevabilite.rendre_inactive()

    # THEN
    parcours_doctoral_repository.save(parcours_doctoral)
    recevabilite_repository.save(recevabilite)
    recevabilite_repository.save(nouvelle_recevabilite)
    ...
    historique.historiser_decision_repetition_recevabilite(
        parcours_doctoral=parcours_doctoral,
