...
def recuperer_derniere_epreuve_confirmation(
    ...
    parcours_doctoral_repository.verifier_existence(parcours_doctoral_id)

    # THEN
    return epreuve_confirmation_repository.get_dto_by_parcours_doctoral_identity(parcours_doctoral_id)
