...
from parcours_doctoral.ddd.formation.domain.service.accepter_activites import (
    AccepterActivites,
)
...
def accepter_activites(
    ...
    notification.notifier_validation_au_doctorant(parcours_doctoral, activites)
