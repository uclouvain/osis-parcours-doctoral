...
class ModifierInscriptionEvaluationTestCase(TestCase):
    @classmethod
    ...
    def test_recuperer_inscription_evaluation(self):
        ...
        identite_inscription_modifiee = self.message_bus.invoke(cmd)

        inscription_modifiee = self.inscription_evaluation_repository.get_dto(identite_inscription_modifiee)

        self.assertEqual(inscription_modifiee.uuid, self.inscription.entity_id.uuid)
        self.assertEqual(inscription_modifiee.statut, StatutInscriptionEvaluation.ACCEPTEE.name)
        self.assertEqual(inscription_modifiee.session, cmd.session)
