...
def confirmer_reussite_soutenance_publique(
    cmd: 'ConfirmerReussiteSoutenancePubliqueCommand',
    ...
    # WHEN
    parcours_doctoral.confirmer_reussite_soutenance_publique()
    ...
    historique.historiser_decision_reussie_soutenance_publique(
        parcours_doctoral=parcours_doctoral,
