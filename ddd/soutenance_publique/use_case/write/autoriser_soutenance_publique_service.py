...
def autoriser_soutenance_publique(
    cmd: 'AutoriserSoutenancePubliqueCommand',
    ...
    # WHEN
    parcours_doctoral.autoriser_soutenance_publique()
    ...
    historique.historiser_autorisation_soutenance_publique(
        parcours_doctoral=parcours_doctoral,
