...
def supprimer_promoteur(
    ...
    # THEN
    notification.notifier_suppression_membre(parcours_doctoral, promoteur_id)
    historique.historiser_suppression_membre(parcours_doctoral, groupe_supervision, promoteur_id, cmd.matricule_auteur)
