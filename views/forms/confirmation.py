...
class ConfirmationFormView(
    ...
    template_name = 'parcours_doctoral/forms/confirmation.html'
    form_class = ConfirmationForm
    permission_required = 'parcours_doctoral.change_confirmation'

    def get_form_kwargs(self):
        kwargs = super().get_form_kwargs()
        kwargs['parcours_doctoral_status'] = self.parcours_doctoral.status
        return kwargs
