...
class ExtensionRequestFormView(
    ...
    def dispatch(self, request, *args, **kwargs):
        if self.parcours_doctoral.status != ChoixStatutParcoursDoctoral.ADMIS.name and self.parcours_doctoral.status != ChoixStatutParcoursDoctoral.CONFIRMATION_SOUMISE.name:
