...
MAPPING_ADMISSION_PRE_ADMISSION: dict[str, str] = {
    'ADMISSION': ChoixTypeAdmission.ADMISSION.name,
    'PRE_ADMISSION': ChoixTypeAdmission.PRE_ADMISSION.name,
}
...
class DoctorateImportModel(BaseModel):
    ...
    choix_formation_admission_preadmission: Literal[*MAPPING_ADMISSION_PRE_ADMISSION]
    choix_formation_secteur: str
    choix_formation_sigle_doctorat: ForeignKey
    choix_formation_commission_proximite: Literal[*MAPPING_COMMISSION_PROXIMITE]
    choix_formation_date_admission: date
    projet_recherche_duree_prevue_realisation_doctorat: int = Field(ge=0, le=200)
    projet_recherche_temps_consacre_these: int = Field(ge=0, le=100)
...
class DoctorateImportFromXLSXView(ImportFromXLSXView):
    ...
    # permission_required = 'parcours_doctoral.import_doctorates_from_xlsx'
    ...
    def save_worksheet_data(self):
        ...
        for validated_object in doctorate_worksheet_config.validated_objects:
            ...
            doctorate = ParcoursDoctoral(
                ...
                admission_type=MAPPING_ADMISSION_PRE_ADMISSION[validated_object.choix_formation_admission_preadmission],
                ...
                proximity_commission=MAPPING_COMMISSION_PROXIMITE[
            ...
            if doctorate.admission_type == ChoixTypeAdmission.ADMISSION.name:
