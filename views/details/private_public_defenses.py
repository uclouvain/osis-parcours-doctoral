...
class PrivatePublicDefensesDetailView(PrivateDefenseCommonViewMixin, ParcoursDoctoralViewMixin, TemplateView):
    template_name = 'parcours_doctoral/details/private_public_defenses.html'
    permission_required = 'parcours_doctoral.view_private_public_defenses'
