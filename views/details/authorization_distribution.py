...
class AuthorizationDistributionCommonViewMixin(ParcoursDoctoralViewMixin):
    @cached_property
    ...
    def get_success_url(self):
        return resolve_url('parcours_doctoral:authorization-distribution', uuid=self.parcours_doctoral_uuid)
...
class AuthorizationDistributionDetailView(AuthorizationDistributionCommonViewMixin, TemplateView):
    ...
    permission_required = 'parcours_doctoral.view_authorization_distribution'
