...
from parcours_doctoral.ddd.defense_privee_soutenance_publique.commands import (
    ...
    InviterJuryDefensePriveeEtSoutenancePubliqueCommand,
)
...
__namespace__ = 'private-public-defenses'


__all__ = [
    'PrivatePublicDefensesAuthorisationView',
    'PrivatePublicDefensesJuryInvitationView',
    'PrivatePublicDefensesSuccessView',
]


class BasePrivatePublicDefensesActionView(BaseEmailFormView):
    def get_tokens(self):
...
class PrivatePublicDefensesAuthorisationView(BasePrivatePublicDefensesActionView):
    urlpatterns = 'authorise'
    permission_required = 'parcours_doctoral.authorise_private_public_defenses'
    message_on_success = gettext_lazy('The defences have been authorised.')
    email_identifier = PARCOURS_DOCTORAL_EMAIL_PRIVATE_PUBLIC_DEFENSES_AUTHORISATION
    prefix = 'authorise'
...
class PrivatePublicDefensesJuryInvitationView(BasePrivatePublicDefensesActionView):
    urlpatterns = 'jury-invitation'
    permission_required = 'parcours_doctoral.invite_jury_to_private_public_defenses'
    message_on_success = gettext_lazy('The members of the jury have been invited to the defences.')
    email_identifier = PARCOURS_DOCTORAL_EMAIL_PRIVATE_PUBLIC_DEFENSES_JURY_INVITATION
    disabled_form = True
...
class PrivatePublicDefensesSuccessView(BasePrivatePublicDefensesActionView):
    urlpatterns = 'success'
    permission_required = 'parcours_doctoral.make_private_public_defenses_decision'
    email_identifier = PARCOURS_DOCTORAL_EMAIL_PRIVATE_PUBLIC_DEFENSES_ON_SUCCESS
    prefix = 'success'
