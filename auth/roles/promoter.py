...
class Promoter(AdmissionPromoter):
    ...
    def rule_set(cls):
        rules = {
            ...
            'parcours_doctoral.api_change_jury_role': is_parcours_doctoral_reference_promoter & is_jury_signing_in_progress,
            'parcours_doctoral.api_approve_jury': is_parcours_doctoral_reference_promoter & is_jury_signing_in_progress,
            # PhD training
