...
from parcours_doctoral.auth.predicates.parcours_doctoral import (
    ...
    submitted_confirmation_paper, has_valid_enrollment,
)
...
PROGRAM_MANAGER_RULES = {
    ...
    'parcours_doctoral.change_cotutelle': is_related_to_an_admission & is_part_of_education_group & has_valid_enrollment,
    ...
    'parcours_doctoral.change_confirmation': is_part_of_education_group & has_valid_enrollment,
    'parcours_doctoral.change_confirmation_extension': is_part_of_education_group & has_valid_enrollment,
    'parcours_doctoral.make_confirmation_decision': is_part_of_education_group & submitted_confirmation_paper & has_valid_enrollment,
    'parcours_doctoral.send_message': is_part_of_education_group,
    'parcours_doctoral.upload_pdf_confirmation': is_part_of_education_group & has_valid_enrollment,
    # -- Formation doctorale
