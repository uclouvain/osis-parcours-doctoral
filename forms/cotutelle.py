    ...
    def clean(self):
        ...
        if cleaned_data.get('cotutelle') == 'YES':
            ...
            if cleaned_data.get('autre_institution'):
                ...
                cleaned_data['autre_institution_nom'] = ''
                cleaned_data['autre_institution_adresse'] = ''

                if not cleaned_data.get('institution'):
                    self.add_error('institution', FIELD_REQUIRED_MESSAGE)
        else:
            cleaned_data['motivation'] = ''
            cleaned_data['institution_fwb'] = None
            cleaned_data['institution'] = ''
            cleaned_data['demande_ouverture'] = []
            cleaned_data['convention'] = []
            cleaned_data['autres_documents'] = []
            cleaned_data['autre_institution_nom'] = ''
            cleaned_data['autre_institution_adresse'] = ''
