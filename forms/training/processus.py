...
class BatchActivityForm(forms.Form):
    ...
    def __init__(self, parcours_doctoral_id=None, *args, **kwargs):
        super().__init__(*args, **kwargs)
        self.fields['activity_ids'].queryset = Activity.objects.filter(parcours_doctoral_id=parcours_doctoral_id)
