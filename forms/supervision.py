...
from parcours_doctoral.utils.country import get_country_initial_choices
...
class MemberSupervisionForm(forms.Form):
...
class SupervisionForm(MemberSupervisionForm):
