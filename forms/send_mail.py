...
class SendMailForm(forms.Form):
    ...
    body = RichTextFormField(
        label=_("Message for the student"),
    ...
    def __init__(self, parcours_doctoral: 'ParcoursDoctoral', *args, **kwargs):
        ...
        self.fields['recipient'].initial = '{student.first_name} {student.last_name} ({student.email})'.format(
            student=self.parcours_doctoral.student,
        )
