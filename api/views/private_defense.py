...
from parcours_doctoral.ddd.defense_privee.commands import (
    ...
    RecupererDerniereDefensePriveeQuery, RecupererIdentifiantDerniereDefensePriveeQuery, SoumettreDefensePriveeCommand,
...
class PrivateDefenseListAPIView(DoctorateAPIPermissionRequiredMixin, GenericAPIView):
    ...
    filter_backends = []
    permission_mapping = {
        'GET': 'parcours_doctoral.view_private_defense',
        'PUT': 'parcours_doctoral.change_private_defense',
    }
...
class PrivateDefenseAPIView(DoctorateAPIPermissionRequiredMixin, mixins.RetrieveModelMixin, GenericAPIView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        serializer = ConfirmationPaperDTOSerializer(instance=private_defense)
        return Response(serializer.data)
