...
class AuthorizationDistributionDTOSerializer(DTOSerializer):
    """Contains the information related to the distribution authorization."""

    class Meta:
        source = AutorisationDiffusionTheseDTO


class UpdateAuthorizationDistributionSerializer(DTOSerializer):
    """Contains the submitted data to update the distribution authorization."""
