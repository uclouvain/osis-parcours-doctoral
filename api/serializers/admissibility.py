...
class AdmissibilityDTOSerializer(DTOSerializer):
    """Contains the information related to the admissibility."""

    class Meta:
        source = RecevabiliteDTO


class SubmitAdmissibilitySerializer(DTOSerializer):
    """Contains the submitted data to complete an admissibility."""
