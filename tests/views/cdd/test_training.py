...
from parcours_doctoral.tests.factories.activity import (
    ConferenceFactory,
    ServiceFactory,
    UclCourseFactory, PublicationFactory, ActivityFactory, CourseFactory, CommunicationFactory,
    SeminarCommunicationFactory, SeminarFactory, ResidencyFactory, ConferenceCommunicationFactory,
    ConferencePublicationFactory, ResidencyCommunicationFactory, VaeFactory, PaperFactory,
)
...
class DoctorateTrainingActivityViewTestCase(TestCase):
    ...
    def setUpTestData(cls):
        # A parcours_doctoral without doctoral and complementary training
        cls.restricted_parcours_doctoral = ParcoursDoctoralFactory()
        CddConfiguration.objects.create(cdd=cls.restricted_parcours_doctoral.training.management_entity)
        ...
        ProgramManagerFactory(education_group=cls.restricted_parcours_doctoral.training.education_group, person=manager_person)
    ...
    def test_accept_activities(self):
        communication = CommunicationFactory(parcours_doctoral=self.parcours_doctoral, status=StatutActivite.SOUMISE.name)
