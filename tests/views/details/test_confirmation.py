...
class ConfirmationDetailViewTestCase(TestCase):
    ...
    def test_confirmation_detail_cdd_user_without_confirmation_paper(self):
        ...
        self.assertEqual(
            response.context.get('parcours_doctoral').uuid, str(self.parcours_doctoral_without_confirmation_paper.uuid)
        )
    ...
    def test_confirmation_detail_cdd_user_with_confirmation_papers(self):
        ...
        self.assertEqual(
            response.context.get('parcours_doctoral').uuid, str(self.parcours_doctoral_with_confirmation_papers.uuid)
        )
