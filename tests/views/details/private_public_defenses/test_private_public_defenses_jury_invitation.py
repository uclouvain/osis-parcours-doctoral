...
class PrivatePublicDefensesJuryInvitationViewTestCase(MockOsisDocumentMixin, TestCase):
    @classmethod
    def setUpTestData(cls):
        ...
        cls.namespace = 'parcours_doctoral:private-public-defenses:jury-invitation'
        cls.details_namespace = 'parcours_doctoral:private-public-defenses'
    ...
    def test_jury_invitation(self):
        ...
        CddMailTemplateFactory(
            identifier=PARCOURS_DOCTORAL_EMAIL_PRIVATE_PUBLIC_DEFENSES_JURY_INVITATION,
