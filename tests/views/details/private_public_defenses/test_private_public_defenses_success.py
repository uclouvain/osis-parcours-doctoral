...
class PrivatePublicDefensesSuccessViewTestCase(MockOsisDocumentMixin, TestCase):
    @classmethod
    def setUpTestData(cls):
        ...
        cls.path = 'parcours_doctoral:private-public-defenses:success'
        cls.details_path = 'parcours_doctoral:private-public-defenses'
    ...
    def setUp(self):
        ...
        self.doctorate = ParcoursDoctoralFactory(
            ...
            defense_datetime=datetime.datetime(2024, 1, 2),
        )
    ...
    def test_post_success_form_with_invalid_data(self):
        ...
        self.private_defense.minutes = [uuid.uuid4()]
        self.private_defense.save()

        # Missing public defence data
        ...
        self.doctorate.defense_datetime = datetime.datetime.now()
