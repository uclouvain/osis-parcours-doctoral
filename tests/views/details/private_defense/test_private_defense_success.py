...
class PrivateDefenseSuccessViewTestCase(MockOsisDocumentMixin, TestCase):
    @classmethod
    ...
    def test_get_success_form(self):
        ...
        fr_cdd_template = CddMailTemplateFactory(
            identifier=PARCOURS_DOCTORAL_EMAIL_PRIVATE_DEFENSE_ON_SUCCESS,
    ...
    def test_post_success_form_with_valid_data(self):
        ...
        self.assertEqual(self.doctorate.status, ChoixStatutParcoursDoctoral.DEFENSE_PRIVEE_REUSSIE.name)
