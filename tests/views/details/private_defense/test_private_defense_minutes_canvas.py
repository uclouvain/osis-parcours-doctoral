...
class PrivateDefenseMinutesCanvasViewTestCase(MockOsisDocumentMixin, TestCase):
    @classmethod
    def setUpTestData(cls):
        ...
        # Targeted path
        cls.url = resolve_url('parcours_doctoral:private-defense-minutes-canvas', uuid=cls.doctorate.uuid)
