...
class PublicDefenseAuthorisationViewTestCase(MockOsisDocumentMixin, TestCase):
    @classmethod
    def setUpTestData(cls):
        ...
        cls.namespace = 'parcours_doctoral:public-defense:authorise'
    ...
    def test_authorisation(self):
        ...
        self.assertEqual(self.doctorate.status, ChoixStatutParcoursDoctoral.SOUTENANCE_PUBLIQUE_AUTORISEE.name)
