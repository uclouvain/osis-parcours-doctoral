...
class AdmissibilityDetailViewTestCase(MockOsisDocumentMixin, TestCase):
    @classmethod
    def setUpTestData(cls):
        ...
        cls.namespace = 'parcours_doctoral:admissibility'
    ...
    def test_with_no_admissibility(self):
    ...
    def test_with_one_admissibility(self):
        self.client.force_login(self.manager.user)
    ...
    def test_with_several_admissibilities(self):
        self.client.force_login(self.manager.user)
        ...
        self.assertEqual(other_admissibility.date_decision, old_admissibility.decision_date)
