...
class AdmissibilityFailureViewTestCase(MockOsisDocumentMixin, TestCase):
    @classmethod
    def setUpTestData(cls):
        ...
        cls.path = 'parcours_doctoral:admissibility:failure'
    ...
    def test_post_failure_form_with_valid_data(self):
        ...
        self.assertEqual(self.doctorate.status, ChoixStatutParcoursDoctoral.RECEVABILITE_EN_ECHEC.name)
