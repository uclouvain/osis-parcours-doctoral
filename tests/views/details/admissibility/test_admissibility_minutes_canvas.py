...
class AdmissibilityMinutesCanvasViewTestCase(MockOsisDocumentMixin, TestCase):
    @classmethod
    def setUpTestData(cls):
        ...
        cls.admissibility = AdmissibilityFactory(parcours_doctoral=cls.doctorate)

        cls.manager = ProgramManagerFactory(education_group=cls.doctorate.training.education_group).person.user

        # Targeted path
        cls.url = resolve_url('parcours_doctoral:admissibility-minutes-canvas', uuid=cls.doctorate.uuid)
    ...
    def setUp(self):
        ...
        # Mock osis-document
        patcher = patch(
            'parcours_doctoral.exports.admissibility_minutes_canvas.get_remote_token',
    ...
    def test_get_admissibility_canvas_redirect_to_the_document_url(self):
        ...
        self.assertEqual(self.admissibility.minutes_canvas, [uuid.UUID('4bdffb42-552d-415d-9e4c-725f10dce228')])
