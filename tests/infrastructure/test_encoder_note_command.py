...
class EncoderNoteCommandTestCase(TestCase):
    ...
    def test_with_valid_evaluation(self):
        ...
        self.assertEqual(first_assessment_enrollment.mark, '10')
        self.assertEqual(course.mark, '10')
        ...
        self.assertEqual(first_assessment_enrollment.mark, '10')
        self.assertEqual(second_assessment_enrollment.mark, '15')
        self.assertEqual(course.mark, '15')
        self.assertTrue(course.course_completed)
        ...
        self.assertEqual(first_assessment_enrollment.mark, '10')
        self.assertEqual(second_assessment_enrollment.mark, '17')
        self.assertEqual(course.mark, '17')
        self.assertTrue(course.course_completed)
    ...
    def test_with_an_invalid_mark(self):
        ...
        self.assertEqual(first_assessment_enrollment.mark, 'S')
        self.assertEqual(course.mark, '')
        ...
        self.assertEqual(first_assessment_enrollment.mark, 'S')
        self.assertEqual(second_assessment_enrollment.mark, '9.99')
        self.assertEqual(course.mark, '')
        self.assertFalse(course.course_completed)
        ...
        self.assertEqual(first_assessment_enrollment.mark, 'S')
        self.assertEqual(second_assessment_enrollment.mark, '9.99')
        self.assertEqual(third_assessment_enrollment.mark, '10')
        self.assertEqual(course.mark, '10')
        self.assertTrue(course.course_completed)
