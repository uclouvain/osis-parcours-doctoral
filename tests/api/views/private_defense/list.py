...
class PrivateDefenseListAPIViewTestCase(DocumentCopyModelMixin, APITestCase):
    @classmethod
    ...
    def test_get_with_several_private_defenses(self):
        ...
        self.assertEqual(private_defenses[0].get('est_active'), second_private_defense.is_active)
        ...
        self.assertEqual(private_defenses[1].get('est_active'), first_private_defense.is_active)
