...
class PublicDefenseAPIViewTestCase(MockOsisDocumentMixin, APITestCase):
    ...
    def test_edit_a_known_private_defense_with_valid_data(self):
        ...
        self.assertEqual(self.doctorate.defense_language, self.data['langue'])
        self.assertEqual(self.doctorate.other_defense_language, self.data['autre_langue'])
        ...
        self.assertEqual(self.doctorate.status, ChoixStatutParcoursDoctoral.SOUTENANCE_PUBLIQUE_SOUMISE.name)
        self.assertEqual(self.doctorate.defense_language, ChoixLangueDefense.OTHER.name)
        self.assertEqual(self.doctorate.other_defense_language, new_data['autre_langue'])
