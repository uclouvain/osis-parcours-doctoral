...
class ParcoursDoctoralAPIViewTestCase(CheckActionLinksMixin, APITestCase):
    ...
    def test_get_parcours_doctoral_student(self):
        ...
        # Public defense
        self.assertEqual(json_response['langue_soutenance_publique'], self.doctorate.defense_language.code)
        self.assertEqual(json_response['nom_langue_soutenance_publique'], self.doctorate.defense_language.name)
