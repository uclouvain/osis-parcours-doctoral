...
class DoctorateListViewTestCase(QueriesAssertionsMixin, APITestCase):
    @classmethod
    ...
    def setUpTestData(cls):
        ...
        with freezegun.freeze_time('2023-01-02'):
            cls.second_doctorate = ParcoursDoctoralFactory(
                ...
                student=cls.first_doctorate.student,
            )
        ...
        cls.other_student = cls.other_doctorate.student
        cls.no_role_user = PersonFactory().user

        cls.student_list_url = resolve_url('parcours_doctoral_api_v1:list')
        cls.other_student_list_url = resolve_url('parcours_doctoral_api_v1:list')
    ...
    def test_list_with_current_student(self):
        ...
        self.assertEqual(first_doctorate['formation']['sigle_entite_gestion'], self.commission.acronym)
        self.assertEqual(first_doctorate['formation']['intitule_entite_gestion'], self.commission.title)
        ...
        self.assertEqual(first_doctorate['formation']['code_secteur'], self.sector.acronym)
        self.assertEqual(first_doctorate['formation']['intitule_secteur'], self.sector.title)
    ...
    def test_list_with_other_student(self):
        ...
        self.assertEqual(json_response[0]['uuid'], str(self.other_doctorate.uuid))
