...
from parcours_doctoral.ddd.dtos.parcours_doctoral import CotutelleDTO, ProjetDTO
...
class ParcoursDoctoralRepository(IParcoursDoctoralRepository):
    ...
    def get(cls, entity_id: 'ParcoursDoctoralIdentity') -> 'ParcoursDoctoral':
        try:
            parcours_doctoral: ParcoursDoctoralModel = ParcoursDoctoralModel.objects.get(uuid=entity_id.uuid)
        ...
        return ParcoursDoctoral(
            ...
            cotutelle=Cotutelle(
                ...
                institution=str(parcours_doctoral.cotutelle_institution) if parcours_doctoral.cotutelle_institution else "",
            ...
            projet=Projet(
                ...
                langue_redaction_these=parcours_doctoral.thesis_language.code if parcours_doctoral.thesis_language else '',
                institut_these=InstitutIdentity(
                    parcours_doctoral.thesis_institute.uuid) if parcours_doctoral.thesis_institute_id else None,
    ...
    def get_dto(cls, entity_id: 'ParcoursDoctoralIdentity') -> 'ParcoursDoctoralDTO':
        ...
        return ParcoursDoctoralDTO(
            ...
            intitule_formation=parcours_doctoral.training.title
            if get_language() == settings.LANGUAGE_CODE_FR
            else parcours_doctoral.training.title_english,
            titre_these=parcours_doctoral.project_title,
            type_financement=parcours_doctoral.financing_type,
            autre_bourse_recherche=parcours_doctoral.other_international_scholarship,
            ...
            cotutelle=CotutelleDTO(
                ...
                institution_fwb=parcours_doctoral.cotutelle_institution_fwb,
                institution=str(parcours_doctoral.cotutelle_institution) if parcours_doctoral.cotutelle_institution else "",
                autre_institution=parcours_doctoral.cotutelle.autre_institution_nom or parcours_doctoral.cotutelle.autre_institution_adresse,
                autre_institution_nom=parcours_doctoral.cotutelle_other_institution_name,
                autre_institution_adresse=parcours_doctoral.cotutelle_other_institution_address,
                demande_ouverture=parcours_doctoral.cotutelle_opening_request if parcours_doctoral.cotutelle_opening_request else [],
                convention=parcours_doctoral.cotutelle_convention if parcours_doctoral.cotutelle_convention else [],
                autres_documents=parcours_doctoral.cotutelle_other_documents if parcours_doctoral.cotutelle_other_documents else [],
            ) if parcours_doctoral.cotutelle else None,
            projet=ProjetDTO(
                titre=parcours_doctoral.project_title,
                resume=parcours_doctoral.project_abstract,
                ...
                nom_institut_these=parcours_doctoral.thesis_institute and parcours_doctoral.thesis_institute.title or '',
                sigle_institut_these=parcours_doctoral.thesis_institute and parcours_doctoral.thesis_institute.acronym or '',
                lieu_these=parcours_doctoral.thesis_location,
