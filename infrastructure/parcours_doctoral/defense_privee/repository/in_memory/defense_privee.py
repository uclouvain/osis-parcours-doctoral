...
class DefensePriveeInMemoryRepository(InMemoryGenericRepository, IDefensePriveeRepository):
    ...
    def build_dto_from_model(cls, entity: 'DefensePrivee') -> 'DefensePriveeDTO':
        return DefensePriveeDTO(
            ...
            titre_these=entity.titre_these,
    ...
    def get_active_dto_by_parcours_doctoral_identity(
        ...
        entity_id = cls.get_active_identity_by_parcours_doctoral_identity(parcours_doctoral_entity_id)
        return cls.get_dto(entity_id=entity_id)
    ...
    def get_active_identity_by_parcours_doctoral_identity(
        ...
        entity: Optional[DefensePrivee] = next(
            (entity for entity in cls.entities if entity.est_active and entity.parcours_doctoral_id == parcours_doctoral_entity_id),
            None,
        )
