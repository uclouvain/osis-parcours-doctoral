...
from parcours_doctoral.infrastructure.parcours_doctoral.jury.repository.jury import INSTITUTION_UCL
...
class JuryService(IJuryService):
    ...
    def recuperer_verificateur(
        ...
        entity = (
            ParcoursDoctoral.objects
            .select_related('thesis_institute__entity')
